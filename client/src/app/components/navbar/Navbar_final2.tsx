  ...
  return (
    <nav className="font-Inter h-[70px] w-full bg-white shadow-md">
      ...
      <div className="mx-auto flex max-w-7xl  ">
        ...
        {/* navbar links */}
        <div className="hidden text-gray-700 flex-row items-center h-[70px] md:flex  md:gap-4 lg:gap-8">
          <Link className="border-gray-500  hover:border-b-6" href="/">
            Homepage
          </Link>
          <Link className="border-gray-500 hover:border-b-6" href="/faq">
            FAQ
          </Link>
          <Link
            className="border-gray-500  hover:border-b-6"
