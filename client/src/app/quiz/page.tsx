...
const quizData: QuizData = {
  "start": {
    ...
    description: "Welcome to the UoA Support Navigator. Answer a few quick questions so we can guide you to the right resources.",
    buttonText: "Start!",
  ...
  "imLost": {
    ...
    description: "It's okay to feel lost. Here are some resources that might help:",
    resources: [
      { text: "Student Services Online", url: "https://www.auckland.ac.nz/en/students/my-tools/sso.html" },
  ...
  "financial": {
    ...
    resources: [
      ...
      { text: "StudyLink (Apply for loan or course cost)", url: "https://www.studylink.govt.nz/" },
      { text: "Financial Wellbeing", url: "https://www.auckland.ac.nz/en/students/student-support/personal-support/be-well/financial-wellbeing.html" },
      { text: "Student Emergency Fund", url: "https://www.auckland.ac.nz/en/study/fees-and-money-matters/financial-support/hardship-support.html" }
    ]
  },
  "academic": {
    type: "result",
    ...
    resources: [
      { text: "UoA Learning Support", url: "https://www.auckland.ac.nz/en/students/student-support/academic-support.htmll" },
      { text: "Been accused of misconduct (Information)", url: "https://www.auckland.ac.nz/en/staff/education-office/academic-integrity/academic-integrity-policies-and-guidelines/breaches-of-academic-integrity.html" } 
    ]
  },
  "poorMentalHealth": {
    type: "question",
  ...
  "notYetAccessedUoA": {
    ...
    description: "It's a great step to seek support. Here are some internal options:",
    resources: [
      { text: "Campus Care (good place to start)", url: "https://www.auckland.ac.nz/en/students/student-support/personal-support/te-papa-manaaki-campus-care.html" },
      { text: "Health and Counselling Appointments", url: "https://www.auckland.ac.nz/en/students/student-support/personal-support/student-health-counselling.html" }
    ]
  },
  "lookingForExternalSupports": {
    type: "result",
    title: "External Support Options",
    description: "If you've already accessed UoA support, here are some external options:",
    resources: [
      { text: "External resources in Auckland", url: "https://mentalhealth.org.nz/help/accessing-mental-health-services" }, 
        ...
        {currentScreen.type === "question" && (
          <div>
            ...
            <div className="flex flex-col gap-4 mb-8">
              {(currentScreen as QuestionScreen).options.map((option: Option) => (
                <Button
                  key={option.text}
        ...
        {currentScreen.type === "result" && (
          <div className="text-center">
            ...
            <div className="flex flex-col gap-4 mb-10">
              {(currentScreen as ResultScreen).resources.map((resource: Resource) => (
                <a
                  key={resource.text}
                  href={resource.url}
                  target="_blank"
