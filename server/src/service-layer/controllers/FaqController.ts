...
import { FaqCreationParams, FaqUpdateParams } from 'data-layer/models/Faq'
import FaqService from 'data-layer/services/FaqService'
import { FaqResponse, GetAllFaqsResponse } from 'service-layer/response-models/FaqResponse'
...
export class FaqController extends Controller {
  @Get()
    ...
    public async createFaq(@Body() newFaq: FaqCreationParams): Promise<FaqResponse> {
        try {
