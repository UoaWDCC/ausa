    ...
    <div className="font-RG">
      <div className="bg-white font-RK">
        <div className="flex flex-col items-center overflow-hidden bg-[#ffffff]">
          <div className="flex flex-col mt-2 w-[90%] md:w-[95%] md:justify-center items-center xl:flex-row lg:max-w-[1500px] xl:max-w-[1800px] bg-[#D9D9D9] p-8 xl:p-10 rounded-[55px] gap-10 ">
